...
import { GeoFilter } from "../../app/components/GeoFilter";
      ...
      <div className="px-4 py-5 space-y-4">
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm space-y-3">
          <GeoFilter
            ...
            initialVille={filters.ville}
            onPaysChange={(pays) => setFilter("pays", pays)}
            onVilleChange={(ville) => setFilter("ville", ville)}
          />
