...
import { GeoSelect } from "../../app/components/GeoSelect";
      ...
      <div className="px-4 py-5 space-y-4">
        ...
        {showForm && (
          <div className="bg-white rounded-2xl p-4 shadow-sm space-y-4">
            ...
            <GeoSelect
              initialPays={form.pays}
              initialVille={form.ville}
              initialQuartier={form.quartier}
              onPaysChange={(pays) => set("pays", pays)}
              onVilleChange={(ville) => set("ville", ville)}
              onQuartierChange={(quartier) => set("quartier", quartier)}
            />
